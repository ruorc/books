...
interface AboutCardProps {
  ...
  iconColorClass: string; // Tailwinds color class e.g., 'bg-sky-500/10 text-sky-500'
}
  ...
  return (
    <div className="p-5 rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/50 flex items-start gap-4 transition-colors duration-200">
      ...
      <div>
        ...
        <p className="text-lg font-extrabold mt-1 text-slate-900 dark:text-slate-50 capitalize">
          {value}
        </p>
